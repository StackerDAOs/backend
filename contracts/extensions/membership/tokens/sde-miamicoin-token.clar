...
(define-fungible-token MiamiCoin TOTAL_SUPPLY) ;; 1m tokens

(define-data-var tokenName (string-ascii 32) "MiamiCoin")
(define-data-var tokenSymbol (string-ascii 10) "MIA")
